...
/* The orbit the five benefits sit on. Drawn faintly so the ring reads as a
   deliberate armillary rather than five circles floating at random — the
   diameter is twice the 400px translateY below. */
...
/* Below the width the orbit needs (2 x 400px radius + a 305px circle), the six
   benefits become a plain grid — they used to overlap into an unreadable pile. */
...
<circle cx="50" cy="50" r="44" fill="none" stroke="#2d5a4f" stroke-width="1" opacity="0.18"/>
<g fill="#2d5a4f" opacity="0.32"><circle cx="30" cy="30" r="3"/><circle cx="43.3" cy="30" r="3"/><circle cx="56.7" cy="30" r="3"/><circle cx="70" cy="30" r="3"/><circle cx="30" cy="43.3" r="3"/><circle cx="43.3" cy="43.3" r="3"/><circle cx="70" cy="43.3" r="3"/><circle cx="30" cy="56.7" r="3"/><circle cx="43.3" cy="56.7" r="3"/><circle cx="56.7" cy="56.7" r="3"/><circle cx="70" cy="56.7" r="3"/><circle cx="30" cy="70" r="3"/><circle cx="43.3" cy="70" r="3"/><circle cx="56.7" cy="70" r="3"/><circle cx="70" cy="70" r="3"/></g>
<circle cx="56.7" cy="43.3" r="4.5" fill="#2d5a4f"/>
<circle cx="56.7" cy="43.3" r="10" fill="none" stroke="#2d5a4f" stroke-width="2">
<animate attributeName="r" values="10;13.5;10" dur="3.6s" repeatCount="indefinite"/>
...
<div class="benefit-icon">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="60" height="60" aria-hidden="true" focusable="false">
<circle cx="50" cy="50" r="40" fill="none" stroke="#2d5a4f" stroke-width="1" opacity="0.22"/>
<path d="M56 34 h12 a16 16 0 0 1 0 32 h-12" fill="none" stroke="#2d5a4f" stroke-width="2.5" stroke-linecap="round"/>
<rect x="18" y="38" width="20" height="24" rx="4" fill="none" stroke="#2d5a4f" stroke-width="2.5"/>
<path d="M38 45 h18 M38 55 h18" stroke="#2d5a4f" stroke-width="2.5" stroke-linecap="round"/>
<path d="M52 14 l-6 10 h7 l-6 10" fill="none" stroke="#b8a080" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
</div>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="60" height="60" aria-hidden="true" focusable="false">
<circle cx="50" cy="50" r="40" fill="none" stroke="#2d5a4f" stroke-width="1" opacity="0.22"/>
<circle cx="22" cy="50" r="5" fill="#2d5a4f"/>
<path d="M27 50 C46 50 53 27 72 27" fill="none" stroke="#2d5a4f" stroke-width="1.5" opacity="0.3"/>
<path d="M27 50 C46 50 53 73 72 73" fill="none" stroke="#2d5a4f" stroke-width="1.5" opacity="0.3"/>
<circle cx="76" cy="27" r="3.5" fill="none" stroke="#2d5a4f" stroke-width="1.5" opacity="0.4"/>
<circle cx="76" cy="73" r="3.5" fill="none" stroke="#2d5a4f" stroke-width="1.5" opacity="0.4"/>
<path d="M27 50 H71" fill="none" stroke="#2d5a4f" stroke-width="2.75" stroke-linecap="round"/>
<circle cx="77" cy="50" r="5.5" fill="#2d5a4f"/>
</svg>
</div>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="60" height="60" aria-hidden="true" focusable="false">
<circle cx="50" cy="50" r="40" fill="none" stroke="#2d5a4f" stroke-width="1" opacity="0.22"/>
<path d="M24 31 H72 M24 42 H72 M24 53 H56" stroke="#2d5a4f" stroke-width="2.5" stroke-linecap="round"/>
<path d="M29 58 V69" stroke="#b8a080" stroke-width="1.5" stroke-dasharray="3 3"/>
<rect x="21" y="69" width="17" height="13" rx="3" fill="none" stroke="#b8a080" stroke-width="2"/>
<circle cx="69" cy="69" r="12" fill="none" stroke="#2d5a4f" stroke-width="2.5"/>
<path d="M63 69 l4.5 4.5 L76 65" fill="none" stroke="#2d5a4f" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
</div>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="60" height="60" aria-hidden="true" focusable="false">
<circle cx="50" cy="50" r="40" fill="none" stroke="#2d5a4f" stroke-width="1" opacity="0.22"/>
<path d="M24 24 V78 H80" fill="none" stroke="#2d5a4f" stroke-width="1.5" opacity="0.32" stroke-linecap="round"/>
<path d="M30 71 C43 69 53 66 75 61" fill="none" stroke="#b8a080" stroke-width="2" stroke-dasharray="4 4" stroke-linecap="round"/>
<path d="M30 68 C44 64 52 48 74 34" fill="none" stroke="#2d5a4f" stroke-width="2.75" stroke-linecap="round"/>
<circle cx="30" cy="68" r="3.5" fill="#2d5a4f"/>
<circle cx="49" cy="55" r="3.5" fill="#2d5a4f"/>
<circle cx="74" cy="34" r="4.5" fill="#2d5a4f"/>
</svg>
</div>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="60" height="60" aria-hidden="true" focusable="false">
<circle cx="50" cy="50" r="40" fill="none" stroke="#2d5a4f" stroke-width="1" opacity="0.22"/>
<path d="M50 43 V37 M45 55 L36 63 M55 55 L64 62" stroke="#b8a080" stroke-width="1.5" stroke-linecap="round"/>
<path d="M41 16 h11 l7 7 v13 h-18 z" fill="none" stroke="#2d5a4f" stroke-width="2" stroke-linejoin="round"/>
<path d="M52 16 v7 h7" fill="none" stroke="#2d5a4f" stroke-width="2" stroke-linejoin="round"/>
<ellipse cx="26" cy="69" rx="9" ry="3.5" fill="none" stroke="#2d5a4f" stroke-width="2"/>
<path d="M17 69 v9 a9 3.5 0 0 0 18 0 v-9" fill="none" stroke="#2d5a4f" stroke-width="2"/>
<path d="M70 63 l-6 6 l6 6 M78 63 l6 6 l-6 6" fill="none" stroke="#2d5a4f" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<circle cx="50" cy="50" r="7" fill="none" stroke="#2d5a4f" stroke-width="2.5"/>
</svg>
</div>
...
<p style="font-size: 1.125rem; margin-bottom: 2rem; color: #2d3c34;">AutoRAG's document processing pipeline transforms your raw content into optimized datasets through a comprehensive four-stage process: document parsing, intelligent chunking, corpus creation, and automated QA dataset generation.</p>
...
<p style="font-size: 1.125rem; margin-bottom: 2rem; color: #2d3c34;">Our AutoRAG system automatically evaluates multiple retrieval strategies to find the optimal approach for your specific data and use case.</p>
...
<p style="font-size: 1.125rem; margin-bottom: 2rem; color: #2d3c34;">AutoRAG's advanced optimization system evaluates multiple generation strategies to find the optimal configuration for your specific data and use case.</p>
