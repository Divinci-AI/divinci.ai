...
- **Auth0** (par Okta) : Gère l'authentification des utilisateurs et la sécurité des comptes. Traite l'adresse e-mail, le nom et les identifiants de connexion. [Politique de Confidentialité d'Auth0](https://auth0.com/privacy)

### 2.2 Analyses et Rapports de Plantage
- **Firebase Analytics** (par Google) : Collecte des données d'utilisation de l'application, des informations sur l'appareil et des événements d'interaction anonymisés pour nous aider à améliorer nos Services. [Informations sur la Confidentialité de Firebase](https://firebase.google.com/support/privacy)
...
<div class="privacy-controls">
  ...
  <a href="https://na1.hs-data-privacy.com/request/HQr4EERnsbB56WBPrmypbg" target="_blank" rel="noopener noreferrer" class="privacy-btn">
    📥 Soumettre une Demande de Données
  </a>
...
Délégué à la Protection des Données : dpo@divinci.ai
