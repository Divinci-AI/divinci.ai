...
<img src="/cdn-cgi/image/width=1200,format=auto,quality=80/images/rag-arena-hero.png" alt="RAG Arena hero illustration" loading="eager" fetchpriority="high" decoding="async">
...
<h1>RAG Arena &<br>Routage Dynamique</h1>
<p class="subtitle">Comparez plusieurs bases de connaissances côte à côte, découvrez laquelle fonctionne le mieux pour chaque type de question, et laissez le système router automatiquement les futures requêtes vers la source gagnante.</p>
<div class="hero-ctas">
<a href="https://meetings.hubspot.com/michael-mooring/divinci-ai" class="cta-primary" target="_blank">Demander une démo</a>
<a href="/fr/autorag/" class="cta-secondary">Explorer AutoRAG</a>
</div>
</div>
</div>
</div>
...
<h2>Comparaison Côte à Côte des Bases de Connaissances</h2>
<p class="section-subtitle">Envoyez une question à plusieurs configurations RAG simultanément. Voyez comment différentes bases de connaissances répondent, puis choisissez la gagnante.</p>
...
<!-- How It Works -->
<section class="arena-section">
<h2>Comment Fonctionne RAG Arena</h2>
<p class="section-subtitle">Un processus structuré pour trouver la meilleure configuration de base de connaissances pour chaque type de question.</p>
...
<h3>Configurer les Variantes</h3>
<p>Configurez 2 à 8 variantes d'arena, chacune pointant vers un vecteur RAG ou une base de connaissances différente.</p>
</div>
<div class="step-card">
...
<h3>Exécuter en Parallèle</h3>
<p>Envoyez des questions à toutes les variantes simultanément. Chacune récupère le contexte depuis sa propre base de connaissances.</p>
</div>
<div class="step-card">
...
<h3>Comparer et Évaluer</h3>
<p>Visualisez les réponses côte à côte avec des scores de qualité pour la pertinence, les hallucinations et la complétude.</p>
</div>
<div class="step-card">
...
<h3>Apprendre et Router</h3>
<p>Le système apprend quelle base de connaissances gagne pour chaque type de question et route automatiquement les futures requêtes.</p>
</div>
</div>
</section>
...
<h2>Routage RAG Dynamique</h2>
<p class="section-subtitle">Une fois que les résultats de l'arena établissent des préférences, les questions entrantes sont automatiquement routées vers la base de connaissances la plus performante — aucune configuration manuelle requise.</p>
...
<!-- Features -->
<section class="arena-section">
<h2>Conçu pour le RAG Entreprise</h2>
<p class="section-subtitle">Tout ce dont vous avez besoin pour optimiser la qualité de récupération à grande échelle.</p>
<div class="feature-grid">
<div class="feature-card">
<div class="feature-card-icon">
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>
</div>
<h3>Support Multi-Fournisseurs</h3>
<p>Comparez entre Qdrant, Cloudflare Vectorize, Couchbase, MongoDB Atlas et plus encore dans une seule expérience d'arena.</p>
</div>
<div class="feature-card">
<div class="feature-card-icon">
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
</div>
<h3>Évaluation de Qualité Intégrée</h3>
<p>Chaque réponse est notée en temps réel pour la pertinence, les hallucinations, l'exactitude et la complétude.</p>
</div>
<div class="feature-card">
<div class="feature-card-icon">
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
</div>
<h3>Intégration de Correction Automatique</h3>
<p>Les résultats d'arena alimentent la boucle de correction automatique QA, apprenant automatiquement le routage optimal avec des seuils de qualité.</p>
</div>
<div class="feature-card">
<div class="feature-card-icon">
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
</div>
<h3>Piste d'Audit Complète</h3>
<p>Chaque décision de routage est tracée avec la source (arena, correction automatique ou manuelle), les scores et les horodatages dans MongoDB.</p>
</div>
<div class="feature-card">
<div class="feature-card-icon">
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>
</div>
<h3>Routage Rapide via KV</h3>
<p>Les préférences apprises sont stockées dans Cloudflare KV pour des recherches en sous-milliseconde. MongoDB maintient l'historique complet.</p>
</div>
<div class="feature-card">
<div class="feature-card-icon">
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
</div>
<h3>Préconfigurations Arena</h3>
<p>Sauvegardez, nommez et réutilisez les configurations d'arena. Exportez en JSON portable pour partager entre équipes.</p>
</div>
</div>
</section>
...
<!-- Supported Providers -->
<section class="arena-section">
<h2>Fournisseurs de Vecteurs Supportés</h2>
<p class="section-subtitle">Exécutez des expériences d'arena avec n'importe quelle combinaison de bases de données vectorielles.</p>
...
<!-- RAG Architectures -->
<section class="arena-section">
<h2>Architectures de Récupération RAG</h2>
<p class="section-subtitle">Routez les requêtes vers différentes stratégies de récupération selon le type de question. Chaque architecture optimise pour différents cas d'utilisation.</p>
...
<p>Correspondance de similarité sémantique via des embeddings denses. Idéal pour les questions en langage naturel et les recherches conceptuelles.</p>
</div>
...
<h3>Hybride (BM25 + Vectoriel)</h3>
<p>Combine la recherche par mots-clés avec la recherche sémantique via la Fusion de Rang Réciproque. Idéal pour les requêtes techniques précises.</p>
</div>
...
<h3>Réordonnancement</h3>
<p>Récupération initiale suivie d'un réordonnancement cross-encoder pour la précision. Idéal pour les réponses critiques nécessitant une précision maximale.</p>
</div>
...
<h3>RAG Agentique</h3>
<p>Routage piloté par LLM à travers plusieurs bases de connaissances et outils. Idéal pour les questions complexes en plusieurs étapes nécessitant une synthèse.</p>
</div>
...
<h2>Trouvez votre configuration RAG optimale</h2>
<p>Arrêtez de deviner quelle base de connaissances fonctionne le mieux. Laissez RAG Arena vous montrer les données, puis laissez le Routage Dynamique s'occuper du reste.</p>
<div class="hero-ctas">
<a href="https://meetings.hubspot.com/michael-mooring/divinci-ai" class="cta-primary" target="_blank">Demander une démo</a>
<a href="/fr/quality-assurance/" class="cta-secondary">Explorer l'Assurance Qualité</a>
</div>
</section>
</div>
