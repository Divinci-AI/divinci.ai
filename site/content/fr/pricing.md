...
description = "Divinci AI propose des plans tarifaires flexibles pour les entreprises de toutes tailles. Choisissez parmi nos plans Starter, Pro et Enterprise pour créer des solutions IA sur mesure pour votre organisation."
...
.pricing-card.coming-soon::after {
    content: "Bientôt disponible — Contactez-nous pour un accès anticipé";
    position: absolute;
    top: 0;
    left: 0;
    right: 0;
...
<h1 class="pricing-title">Des tarifs simples et transparents</h1>
<p class="pricing-subtitle">Choisissez le plan adapté à votre entreprise. Tous les plans incluent les fonctionnalités principales, les mises à jour et une assistance de base.</p>

<div class="pricing-toggle">
<span class="monthly active">Mensuel</span>
<label class="toggle-switch">
<input type="checkbox" id="pricingToggle">
<span class="toggle-slider"></span>
</label>
<span class="annual">Annuel <span class="has-text-success">(Économisez 20 %)</span></span>
</div>
</div>
...
<p class="pricing-description">Commencez à créer avec Divinci sans frais</p>
...
<div class="pricing-billed">Gratuit, pour toujours</div>
</div>
...
<p class="pricing-description">Parfait pour les petites équipes et les projets individuels</p>
...
<div class="pricing-amount annual">
<div class="pricing-price">
<span class="currency">$</span>24,17<span class="period">/mois</span>
</div>
<div class="pricing-billed">Facturé annuellement (290 $)</div>
</div>
...
<p class="pricing-description">Idéal pour les entreprises et équipes en croissance</p>
...
<div class="pricing-amount annual">
<div class="pricing-price">
<span class="currency">$</span>82,50<span class="period">/mois</span>
</div>
<div class="pricing-billed">Facturé annuellement (990 $)</div>
</div>
...
<p class="pricing-description">Pour les grandes équipes ayant des besoins avancés</p>
</div>

<div class="ep-price-group">
<div class="pricing-amount monthly active">
<div class="pricing-price">
<span class="currency">$</span>499<span class="period">/mois</span>
</div>
</div>

<div class="pricing-amount annual">
<div class="pricing-price">
<span class="currency">$</span>415,83<span class="period">/mois</span>
</div>
<div class="pricing-billed">Facturé annuellement (4 990 $)</div>
</div>
</div>

<div class="ep-cta-wrap">
<a href="https://chat.divinci.app/user/wallet/subscription?plan=enterprise&billing=monthly" class="pricing-cta" data-plan="enterprise" target="_blank" rel="noopener">Commencer</a>
</div>
</div>
...
<h2 class="enterprise-title">Besoin de plus grand ?</h2>
<p class="enterprise-text">Pour les organisations qui ont besoin de plus que le plan Enterprise — développement de modèles IA sur mesure, infrastructure sur site ou dédiée, politiques de sécurité personnalisées et conditions négociées — parlons-en.</p>
<a href="https://meetings.hubspot.com/michael-mooring/divinci-ai" class="enterprise-cta" target="_blank" rel="noopener">Planifier une démo</a>
</div>
</div>
</section>
...
Qu'est-ce qui est inclus dans tous les plans ?
<span class="faq-icon">+</span>
</button>
<div class="faq-answer">
<div class="faq-answer-content">
<p>Tous les plans incluent l'accès à notre plateforme Divinci AI de base, qui vous permet de créer des solutions IA sur mesure. Chaque plan inclut également le traitement de documents de base, des capacités d'extraction de connaissances, des mises à jour régulières et l'accès à nos ressources d'assistance.</p>
</div>
</div>
</div>
...
<div class="faq-answer">
<div class="faq-answer-content">
<p>Les plans payants incluent une allocation mensuelle de crédits (indiquée sur chaque plan ci-dessus) qui couvre l'utilisation des modèles IA, la récupération RAG et d'autres coûts de plateforme mesurés à l'usage. Une fois vos crédits inclus utilisés, l'utilisation supplémentaire est facturée à l'usage à partir du solde de votre portefeuille, aux mêmes tarifs mesurés.</p>
</div>
</div>
</div>
...
<div class="faq-item">
<button class="faq-question">
Puis-je changer de plan à la hausse ou à la baisse ?
<span class="faq-icon">+</span>
</button>
<div class="faq-answer">
<div class="faq-answer-content">
<p>Oui, vous pouvez passer à un plan supérieur à tout moment, et le changement prend effet immédiatement. Pour un changement à la baisse, le changement prend effet à la fin de votre cycle de facturation en cours. Vous recevrez un crédit au prorata pour toute période non utilisée de votre ancien plan lors d'une mise à niveau.</p>
</div>
</div>
</div>
...
<div class="faq-answer">
<div class="faq-answer-content">
<p>Oui — notre plan Gratuit vous permet de commencer à créer avec Divinci sans frais et sans carte de crédit, afin que vous puissiez essayer la plateforme avant de choisir un plan payant.</p>
</div>
</div>
</div>
