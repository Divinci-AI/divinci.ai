...
title = "Strumenti per sviluppatori e documentazione"
description = "Documentazione completa per sviluppatori di Divinci AI — CLI, SDK server, SDK client, MCP SDK, Embed Client e riferimento REST API."
...
<!-- Hero -->
<div class="docs-hero">
<h1>Strumenti per sviluppatori e documentazione</h1>
<p class="subtitle">Tutto ciò che ti serve per integrare Divinci AI nelle tue applicazioni. SDK per ogni piattaforma, una CLI potente e accesso REST API completo.</p>
