...
description = "Divinci AI offre piani tariffari flessibili per aziende di ogni dimensione. Scegli tra i nostri piani Starter, Pro ed Enterprise per creare soluzioni IA personalizzate per la tua organizzazione."
...
<h1 class="pricing-title">Prezzi semplici e trasparenti</h1>
<p class="pricing-subtitle">Scegli il piano più adatto alla tua attività. Tutti i piani includono le funzionalità principali, gli aggiornamenti e il supporto di base.</p>

<div class="pricing-toggle">
<span class="monthly active">Mensile</span>
<label class="toggle-switch">
<input type="checkbox" id="pricingToggle">
<span class="toggle-slider"></span>
</label>
<span class="annual">Annuale <span class="has-text-success">(Risparmia il 20%)</span></span>
</div>
</div>
...
<p class="pricing-description">Perfetto per piccoli team e progetti individuali</p>

<div class="pricing-amount monthly active">
<div class="pricing-price">
<span class="currency">$</span>29<span class="period">/mese</span>
</div>
</div>

<div class="pricing-amount annual">
<div class="pricing-price">
<span class="currency">$</span>24.17<span class="period">/mese</span>
</div>
<div class="pricing-billed">Fatturazione annuale ($290)</div>
</div>
...
<div class="pricing-popular">Più popolare</div>
<h2 class="pricing-plan">Pro</h2>
<p class="pricing-description">Ideale per aziende e team in crescita</p>

<div class="pricing-amount monthly active">
<div class="pricing-price">
<span class="currency">$</span>99<span class="period">/mese</span>
</div>
</div>

<div class="pricing-amount annual">
<div class="pricing-price">
<span class="currency">$</span>82.50<span class="period">/mese</span>
</div>
<div class="pricing-billed">Fatturazione annuale ($990)</div>
</div>
...
<p class="pricing-description">Per team più grandi con esigenze avanzate</p>
</div>

<div class="ep-price-group">
<div class="pricing-amount monthly active">
<div class="pricing-price">
<span class="currency">$</span>499<span class="period">/mese</span>
</div>
</div>

<div class="pricing-amount annual">
<div class="pricing-price">
<span class="currency">$</span>415.83<span class="period">/mese</span>
</div>
<div class="pricing-billed">Fatturazione annuale ($4,990)</div>
</div>
</div>

<div class="ep-cta-wrap">
<a href="https://chat.divinci.app/user/wallet/subscription?plan=enterprise&billing=monthly" class="pricing-cta" data-plan="enterprise" target="_blank" rel="noopener">Inizia ora</a>
</div>
</div>
...
<h2 class="enterprise-title">Hai bisogno di qualcosa di più grande?</h2>
<p class="enterprise-text">Per le organizzazioni che necessitano di più rispetto al piano Enterprise — sviluppo di modelli IA personalizzati, infrastruttura on-premise o dedicata, policy di sicurezza personalizzate e condizioni negoziate — parliamone.</p>
<a href="https://meetings.hubspot.com/michael-mooring/divinci-ai" class="enterprise-cta" target="_blank" rel="noopener">Prenota una demo</a>
</div>
</div>
</section>
...
<p>Tutti i piani includono l'accesso alla piattaforma principale di Divinci AI, che ti permette di creare soluzioni IA personalizzate. Ogni piano include inoltre l'elaborazione di base dei documenti, funzionalità di estrazione della conoscenza, aggiornamenti regolari e accesso alle nostre risorse di supporto.</p>
</div>
</div>
</div>
...
<div class="faq-answer">
<div class="faq-answer-content">
<p>I piani a pagamento includono un'assegnazione mensile di crediti (indicata per ogni piano qui sopra) che copre l'utilizzo dei modelli IA, il recupero RAG e altri costi della piattaforma a consumo. Una volta esauriti i crediti inclusi, l'utilizzo viene fatturato a consumo dal saldo del tuo wallet, alle stesse tariffe a consumo.</p>
</div>
</div>
</div>
...
<div class="faq-item">
<button class="faq-question">
Posso effettuare l'upgrade o il downgrade del mio piano?
<span class="faq-icon">+</span>
</button>
<div class="faq-answer">
<div class="faq-answer-content">
<p>Sì, puoi effettuare l'upgrade del tuo piano in qualsiasi momento e la modifica avrà effetto immediato. Per i downgrade, la modifica avrà effetto alla fine del ciclo di fatturazione in corso. In caso di upgrade, riceverai un credito proporzionale per il tempo non utilizzato del piano precedente.</p>
</div>
</div>
</div>
