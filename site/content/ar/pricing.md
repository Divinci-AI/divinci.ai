+++
title = "خطط الأسعار"
description = "تقدّم Divinci AI خطط أسعار مرنة للأعمال بكافة أحجامها. اختر من خططنا Starter وPro وEnterprise لإنشاء حلول ذكاء اصطناعي مخصصة لمؤسستك."
...
<ul class="pricing-features">
<li>إصدارات متعددة بعلامة بيضاء (White-Label)</li>
<li>رصيد استخدام مُضمَّن بقيمة 100$ شهريًا</li>
<li>نماذج ذكاء اصطناعي مجتمعية ومتميزة</li>
...
<li>رصيد استخدام مُضمَّن بقيمة 500$ شهريًا</li>
<li>نماذج ذكاء اصطناعي مجتمعية ومتميزة</li>
<li>RAG متقدّم (فهارس متعددة، إعادة الترتيب، حدود أعلى)</li>
