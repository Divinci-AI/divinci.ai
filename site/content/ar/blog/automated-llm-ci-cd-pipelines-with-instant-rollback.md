...
description = "الطبقة التشغيلية تحت خط أنابيب الإصدار ذي المراحل الأربع — أيّ القرارات تُطلَق آليًا، وأيّها يتطلّب مدخلًا بشريًا، وكيف يبدو تمرين التراجع الفعلي، ورقم MTTR الذي يخرج في النهاية."
