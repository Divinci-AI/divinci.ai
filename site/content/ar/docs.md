+++
title = "أدوات المطورين والوثائق"
description = "وثائق شاملة للمطورين لـ Divinci AI — CLI وSDK الخادم وSDK العميل وMCP SDK وEmbed Client ومرجع REST API."
...
<!-- Hero -->
<div class="docs-hero">
<h1>أدوات المطورين والوثائق</h1>
<p class="subtitle">كل ما تحتاجه لدمج Divinci AI في تطبيقاتك. SDKs لكل منصة، CLI قوي، ووصول شامل إلى REST API.</p>
