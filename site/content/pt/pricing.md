...
description = "A Divinci AI oferece planos de preços flexíveis para empresas de todas as dimensões. Escolha entre os nossos planos Starter, Pro e Enterprise para criar soluções de IA personalizadas para a sua organização."
...
<h1 class="pricing-title">Preços Simples e Transparentes</h1>
<p class="pricing-subtitle">Escolha o plano certo para o seu negócio. Todos os planos incluem funcionalidades essenciais, atualizações e suporte básico.</p>

<label class="pricing-toggle" for="pricingToggle">
<span class="monthly active">Mensal</span>
<span class="toggle-switch">
<input type="checkbox" id="pricingToggle">
<span class="toggle-slider"></span>
</span>
<span class="annual">Anual <span class="has-text-success">(Poupe 20%)</span></span>
</label>
</div>
...
<p class="pricing-description">Perfeito para pequenas equipas e projetos individuais</p>

<div class="pricing-amount monthly active">
<div class="pricing-price">
<span class="currency">$</span>29<span class="period">/mês</span>
</div>
</div>

<div class="pricing-amount annual">
<div class="pricing-price">
<span class="currency">$</span>24.17<span class="period">/mês</span>
</div>
<div class="pricing-billed">Faturado anualmente ($290)</div>
</div>
...
<p class="pricing-description">Ideal para empresas e equipas em crescimento</p>

<div class="pricing-amount monthly active">
<div class="pricing-price">
<span class="currency">$</span>99<span class="period">/mês</span>
</div>
</div>

<div class="pricing-amount annual">
<div class="pricing-price">
<span class="currency">$</span>82.50<span class="period">/mês</span>
</div>
<div class="pricing-billed">Faturado anualmente ($990)</div>
</div>
...
<p class="pricing-description">Para equipas maiores com necessidades avançadas</p>
</div>

<div class="ep-price-group">
<div class="pricing-amount monthly active">
<div class="pricing-price">
<span class="currency">$</span>499<span class="period">/mês</span>
</div>
</div>

<div class="pricing-amount annual">
<div class="pricing-price">
<span class="currency">$</span>415.83<span class="period">/mês</span>
</div>
<div class="pricing-billed">Faturado anualmente ($4,990)</div>
</div>
</div>

<div class="ep-cta-wrap">
<a href="https://chat.divinci.app/user/wallet/subscription?plan=enterprise&billing=monthly" class="pricing-cta" data-plan="enterprise" target="_blank" rel="noopener">Começar</a>
</div>
</div>
...
<h2 class="enterprise-title">Precisa de algo maior?</h2>
<p class="enterprise-text">Para organizações que precisam de mais do que o plano Enterprise — desenvolvimento personalizado de modelos de IA, infraestrutura on-premise ou dedicada, políticas de segurança personalizadas e condições negociadas — vamos conversar.</p>
<a href="https://meetings.hubspot.com/michael-mooring/divinci-ai" class="enterprise-cta" target="_blank" rel="noopener">Agendar Demonstração</a>
</div>
</div>
</section>
...
<p>Todos os planos incluem acesso à nossa plataforma principal Divinci AI, que lhe permite criar soluções de IA personalizadas. Todos os planos incluem também processamento básico de documentos, capacidades de extração de conhecimento, atualizações regulares e acesso aos nossos recursos de suporte.</p>
</div>
</div>
</div>
...
<div class="faq-item">
<button class="faq-question">
Como funciona a faturação baseada na utilização?
<span class="faq-icon">+</span>
</button>
<div class="faq-answer">
<div class="faq-answer-content">
<p>Os planos pagos incluem uma dotação mensal de créditos (indicada em cada plano acima) que cobre a utilização de modelos de IA, a recuperação RAG e outros custos de plataforma medidos. Depois de utilizados os créditos incluídos, a utilização é faturada em regime pay-as-you-go a partir do saldo da sua carteira, às mesmas taxas medidas.</p>
</div>
</div>
</div>
...
<div class="faq-item">
<button class="faq-question">
Posso atualizar ou reduzir o meu plano?
<span class="faq-icon">+</span>
</button>
<div class="faq-answer">
<div class="faq-answer-content">
<p>Sim, pode atualizar o seu plano a qualquer momento, e a alteração terá efeito imediato. Nas reduções de plano, a alteração terá efeito no final do seu ciclo de faturação atual. Ao atualizar, receberá um crédito proporcional por qualquer período não utilizado do seu plano anterior.</p>
</div>
</div>
</div>
