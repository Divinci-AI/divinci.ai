...
description = "Десять реальных режимов отказа при выпуске кастомных LM в продакшн, каждый сопоставлен со стадией конвейера Divinci — Register, Gate, Roll, Observe — которая ловит его до того, как заметят пользователи."
