...
description = "Как построить регрессионный набор, который ловит дрейф в самой оценке, а не только в модели. Срез-ориентированные ворота, откалиброванные судьи, реплей продакшен-трейсов."
