...
Вот как устроена квитанция для DELETE-патча по GDPR Статья 17 — разобранный пример с условными идентификаторами и цифрами, в формате, задокументированном на [странице комплаенса](/ru/compliance/):
