...
description = "Четырёхэтапный конвейер релизов LLM: гейты на основе Spearman с учётом срезов, canary, отслеживающий качество ответов (а не только p95), атомарный откат за 12 секунд и compliance-расписка по каждому решению."
