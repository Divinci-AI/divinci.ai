...
<!-- Hero -->
<div class="docs-hero">
<h1>Инструменты для разработчиков и документация</h1>
<p class="subtitle">Всё, что нужно, чтобы встроить Divinci AI в ваши приложения. SDK для всех платформ, мощный CLI и полный доступ к REST API.</p>
