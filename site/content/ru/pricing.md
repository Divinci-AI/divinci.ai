...
description = "Divinci AI предлагает гибкие тарифные планы для бизнеса любого размера. Выберите Starter, Pro или Enterprise для создания собственных ИИ-решений."
