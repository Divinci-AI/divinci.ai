+++
title = "料金プラン"
description = "Divinci AI はあらゆる規模のビジネスに柔軟な料金プランを提供します。Starter、Pro、Enterprise プランから選択し、組織向けのカスタム AI ソリューションを構築してください。"
...
<h1 class="pricing-title">シンプルで透明性の高い料金体系</h1>
<p class="pricing-subtitle">ビジネスに最適なプランをお選びください。すべてのプランにはコア機能、アップデート、基本サポートが含まれます。</p>

<label class="pricing-toggle" for="pricingToggle">
<span class="monthly active">月払い</span>
<span class="toggle-switch">
<input type="checkbox" id="pricingToggle">
<span class="toggle-slider"></span>
</span>
<span class="annual">年払い <span class="has-text-success">(20%お得)</span></span>
</label>
</div>
...
<p class="pricing-description">小規模チームや個人プロジェクトに最適</p>

<div class="pricing-amount monthly active">
<div class="pricing-price">
<span class="currency">$</span>29<span class="period">/月</span>
</div>
</div>

<div class="pricing-amount annual">
<div class="pricing-price">
<span class="currency">$</span>24.17<span class="period">/月</span>
</div>
<div class="pricing-billed">年払い ($290)</div>
</div>
...
<div class="pricing-popular">人気No.1</div>
<h2 class="pricing-plan">Pro</h2>
<p class="pricing-description">成長中のビジネスやチームに最適</p>

<div class="pricing-amount monthly active">
<div class="pricing-price">
<span class="currency">$</span>99<span class="period">/月</span>
</div>
</div>

<div class="pricing-amount annual">
<div class="pricing-price">
<span class="currency">$</span>82.50<span class="period">/月</span>
</div>
<div class="pricing-billed">年払い ($990)</div>
</div>
...
<p class="pricing-description">高度なニーズを持つ大規模チーム向け</p>
</div>

<div class="ep-price-group">
<div class="pricing-amount monthly active">
<div class="pricing-price">
<span class="currency">$</span>499<span class="period">/月</span>
</div>
</div>

<div class="pricing-amount annual">
<div class="pricing-price">
<span class="currency">$</span>415.83<span class="period">/月</span>
</div>
<div class="pricing-billed">年払い ($4,990)</div>
</div>
</div>

<div class="ep-cta-wrap">
<a href="https://chat.divinci.app/user/wallet/subscription?plan=enterprise&billing=monthly" class="pricing-cta" data-plan="enterprise" target="_blank" rel="noopener">今すぐ始める</a>
</div>
</div>
...
<h2 class="enterprise-title">さらに大規模なプランをお探しですか?</h2>
<p class="enterprise-text">Enterpriseプラン以上の機能が必要な組織様へ — カスタムAIモデルの開発、オンプレミスまたは専用インフラ、独自のセキュリティポリシー、個別条件でのご契約など、まずはお気軽にご相談ください。</p>
<a href="https://meetings.hubspot.com/michael-mooring/divinci-ai" class="enterprise-cta" target="_blank" rel="noopener">デモを予約する</a>
</div>
</div>
</section>
...
<p>すべてのプランには、カスタムAIソリューションを構築できるDivinci AIのコアプラットフォームへのアクセスが含まれます。また、どのプランにも基本的なドキュメント処理、ナレッジ抽出機能、定期アップデート、サポートリソースへのアクセスが含まれています。</p>
</div>
</div>
</div>
...
<div class="faq-answer">
<div class="faq-answer-content">
<p>有料プランには、AIモデルの利用、RAG検索、その他の従量課金対象のプラットフォームコストをカバーする月間クレジット(各プランに記載)が含まれます。付与されたクレジットを使い切った後は、同じ従量料金でウォレット残高から従量課金されます。</p>
</div>
</div>
</div>
...
<div class="faq-answer">
<div class="faq-answer-content">
<p>はい、いつでもプランをアップグレードでき、変更は即座に反映されます。ダウングレードの場合は、現在の請求サイクルの終了時に変更が適用されます。アップグレード時には、以前のプランで未使用の期間に応じた日割りクレジットが付与されます。</p>
</div>
</div>
</div>
