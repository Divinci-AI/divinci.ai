...
```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8001/
Call log:
  - navigating to "http://localhost:8001/", waiting until "load"

    at /Users/mikeumus/Documents/divinci.ai/tests-new/direct-language-navigation-content.test.js:23:14
```
...
>  23 |   await page.goto(config.baseUrl);
   ...
   70 |   expect(spanishSignUpText).toBe('Regístrate');
   71 |   
