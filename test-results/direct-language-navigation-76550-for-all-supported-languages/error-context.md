...
Call log:
  - navigating to "http://localhost:8001/", waiting until "load"
    ...
    at /Users/mikeumus/Documents/divinci.ai/tests-new/direct-language-navigation-content.test.js:106:16
```
...
> 106 |     await page.goto(`${config.baseUrl}${lang.code === 'en' ? '' : `/${lang.code}/`}`);
  ...
  128 |     expect(signUpText).toBe(expectedTranslations[lang.code].signUp.replace('Registrarse', 'Regístrate'));
  129 |     
